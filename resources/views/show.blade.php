...
<div class="container">
    ...
    <dl class="row mt-3">
        ...
        <dd class="col-sm-9"><img src="{{asset('/storage/' . $product->image)}}" alt="商品画像" width="100"></dd>
    ...
    <div>
            <a href="/edit/{{$product->id}}" class="btn btn-primary btn-sm mx-1">編集</button>
            <a href="{{ route('product.index') }}" class="btn btn-primary btn-sm mx-1">戻る</a>
    </div>
</div>
@endsection